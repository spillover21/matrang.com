...
try {
    ...
    $pgConfig = "host=127.0.0.1 port=5432 dbname=documenso user=documenso password={{DB_PASSWORD}}";
    ...
    echo json_encode([
        ...
        'document_url' => "http://{{SERVER_IP}}:9000/documents/{$envelopeId}",
        's3_path' => $s3Path
    ]);
